...
1) Import and inspect point (.csv format) and polygon (.shp format) data data in QGIS

2) Reproject a layer and conduct vector overlay

3) Normalize data and calculate a new field
